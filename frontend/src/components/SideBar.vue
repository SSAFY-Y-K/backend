<template>
	<aside class="flex w-44 shrink-0 flex-col overflow-y-auto border-r border-slate-100 bg-white">
		<!-- Recent problems -->
		<div class="p-3">
		...
		<div class="p-3">
			...
			<div class="space-y-0.5">
				...
				>
					...
					<svg class="h-3 w-3 shrink-0 text-slate-300" viewBox="0 0 12 12" fill="currentColor">
						<path d="M4 5l2 2 2-2" />
					</svg>
				</RouterLink>
				<RouterLink
